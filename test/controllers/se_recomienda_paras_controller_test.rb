...
class SeRecomiendaParasControllerTest < ActionController::TestCase
  ...
  test "should update se_recomienda_para" do
    patch :update, id: @se_recomienda_para, se_recomienda_para: { clave_materia: @se_recomienda_para.clave_materia, libro: @se_recomienda_para.libro, recomendaciones: @se_recomienda_para.recomendaciones, votos: @se_recomienda_para.votos }
    assert_redirected_to se_recomienda_para_path(assigns(:se_recomienda_para))
  end
