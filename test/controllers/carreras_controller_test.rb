...
class CarrerasControllerTest < ActionController::TestCase
  ...
  test "should create carrera" do
    assert_difference('Carrera.count') do
      post :create, carrera: { facultad: @carrera.facultad, nombre: @carrera.nombre, semestres: @carrera.semestres }
    end
  ...
  test "should update carrera" do
    patch :update, id: @carrera, carrera: { facultad: @carrera.facultad, nombre: @carrera.nombre, semestres: @carrera.semestres }
    assert_redirected_to carrera_path(assigns(:carrera))
  end
