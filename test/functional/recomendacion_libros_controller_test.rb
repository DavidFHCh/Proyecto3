...
class RecomendacionLibrosControllerTest < ActionController::TestCase
  ...
  test "should update recomendacion_libro" do
    put :update, id: @recomendacion_libro, recomendacion_libro: { autor: @recomendacion_libro.autor, clave_materia: @recomendacion_libro.clave_materia, titulo: @recomendacion_libro.titulo, usuario: @recomendacion_libro.usuario }
    assert_redirected_to recomendacion_libro_path(assigns(:recomendacion_libro))
  end
