...
SELECT merge_libros('9780133153910','A First Course In Probability','Sheldon M. Ross');
SELECT merge_libros('9780132397346','Linear Algebra','Lawrence Spence, Arnold J Insel, Stephen H Friedberg');
SELECT merge_libros('9789684528956','El Principito','Antoine de Saint-Exupery');
SELECT merge_libros('9780606259095','Fifty Shades of Grey','E. L. James');
SELECT merge_libros('9783442735648','After Dark','Haruki Murakami');
SELECT merge_libros('9780099485254','Norwegian Wood','Haruki Murakami');
SELECT merge_libros('9780140434187','Wuthering Heights','Emily Bronte');
SELECT merge_libros('9780606039796','The Metamorphosis','Franz Kafka');
